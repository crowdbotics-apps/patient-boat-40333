"""
Django settings for patient_boat_40333 project.
...
ROOT_URLCONF = 'patient_boat_40333.urls'
...
WSGI_APPLICATION = 'patient_boat_40333.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_boat_40333 API",
    "DESCRIPTION": "API documentation for patient_boat_40333 App",
    "VERSION": "v1",
}
